...
$intro .= 'If all tests do not pass, check your PHP version (Zend PHP 4.4.4+ or Roadsend PHP 2.9+) and include file setup. If you need more help, head over to the
